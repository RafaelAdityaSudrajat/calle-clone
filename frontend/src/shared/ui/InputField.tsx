...
const InputField: React.FC<InputFieldProps> = (props) => {
  const baseClasses =
    "w-full mt-1.5 px-4 py-3 border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-dashboardPrimary focus:ring-1 focus:ring-dashboardPrimary transition-all bg-white text-dashboardTextPrimary placeholder:text-slate-400 font-light";
  ...
  if (props.isSelect) {
    const { label, placeholder, isTextArea, isSelect, children, ...rest } =
      props;
    return (
      <div className="flex flex-col w-full mb-5">
        <label className="text-[14px] font-light text-dashboardTextPrimary">
